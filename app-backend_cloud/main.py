...
async def authenticate_users(db: db_dependency, username: str = Form(...), password: str = Form(...)):
    ...
    LDAP_SERVER="ldap://10.133.10.136:389"
    BASE_DN="dc=abl,dc=com,dc=pk"
    DOMAIN="uat.abl.com.pk"
    ...
    # conn.search(search_base=BASE_DN, search_filter=search_filter, attributes=["cn", "mail", "title", "department", "company", "mailnickname", "employeeid"])
