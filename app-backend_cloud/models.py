...
class ABL_speech_analyzer_authenticated_users(Base):
    __tablename__ = 'abl_speech_analyzer_authenticated_users'
    
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    employeeid = Column(Integer, unique=True, nullable=False)
